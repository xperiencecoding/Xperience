                    ...
                    >
                        <div key="a">
                            <div className='profile'>
                                ...
                                <figcaption className="name oxanium bold"> Adam Lueken <a href = "mailto:adam.lueken@d128.org"> <FaEnvelope size = {".55em"} /> </a>  </figcaption>
                        ...
                        <div key="b">
                            <div className='profile'>
                                ...
                                <figcaption className="name oxanium bold"> Rohit Dashaputra  <a href = "mailto:rohit.dashaputra@vhhscougars.org"> <FaEnvelope size = {".55em"} /> </a> </figcaption>
                        ...
                        <div key="c">
                            <div className='profile'>
                                ...
                                <figcaption className="name oxanium bold"> Om Kotwal <a href = "mailto:om.kotwal@vhhscougars.org"> <FaEnvelope size = {".55em"} /> </a>  </figcaption>
                        ...
                        <div key="d">
                            <div className='profile'>
                                ...
                                <figcaption className="name oxanium bold"> Juno Lee  <a href = "mailto:juno.lee@vhhscougars.org"> <FaEnvelope size = {".55em"} /> </a>  </figcaption>
                        ...
                        <div key="e">
                            <div className='profile'>
                                <img src={require("../../img/Sid.jpg")} />
                                <figcaption className="name oxanium bold"> Siddharth Avula  <a href = "mailto:siddharth.avula@vhhscougars.org"> <FaEnvelope size = {".55em"} /> </a>  </figcaption>
                                <figcaption className="caption oxanium"> Senior in high school who enjoys math and computer science. Experience with Java, Javascript, Python, HTML, and CSS. Believes computers are an crucial in society. Wishes to give back to the community and make sure kids have necessary resources to develop their interests. </figcaption>
                            </div>
                        </div>
